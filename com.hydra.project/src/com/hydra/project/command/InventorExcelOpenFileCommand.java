...
public class InventorExcelOpenFileCommand {
	...
	public static void Action(Shell shell, MyTreeItem myTreeItem){
		...
		fileDialog.setFilterNames(new String[] { "Inventor (*.XLSX)" });
		fileDialog.setText("Vohandene Inventor Excel Datei öffnen");
...
//	        		mb.setMessage("Datei " + fileName + " ist bereits geladen.");
