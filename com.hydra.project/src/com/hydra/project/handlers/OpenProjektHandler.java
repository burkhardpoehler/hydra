...
import com.hydra.project.command.OpenProjektFileCommand;
import com.hydra.project.model.MyTreeItem;
import com.hydra.project.parts.LogfileView;
public class OpenProjektHandler {
	...
	public void execute(IWorkbench workbench, @Named(IServiceConstants.ACTIVE_SELECTION)@Optional MyTreeItem myTreeItem,
			...
			LogfileView.log(this + "Projekthandler läuft");
			OpenProjektFileCommand.Action(shell,myTreeItem);
	}
}
