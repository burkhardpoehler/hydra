...
import com.hydra.project.command.Perspective_StandardCommand;
import com.hydra.project.model.MyTreeItem;

/**
 * @author Poehler
 * Schaltet um auf Standardansicht
 *
 */
public class Perspective_StandardHandler {
	...
	public void execute(@Named(IServiceConstants.ACTIVE_SELECTION)@Optional MyTreeItem myTreeItem) {
		...
		Perspective_StandardCommand.execute(mApplication, partService, eModelService);
	}
