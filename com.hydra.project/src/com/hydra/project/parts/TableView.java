...
//				MyNewXViewerCustomizations.setMyTableTreeItem(myTableTreeItem);
	...
	private static void myEventBroker(MyTreeItem myTreeItem){
		...
		if (wasDispatchedSuccessfully) LogfileView.log(TableView.class, " Nachricht aus TableViewer gesendet "+ myTreeItem.getBezeichnung());
	}
	@Focus
	public void setFocus() {
//		viewer.getControl().setFocus();
		LogfileView.log(TableView.class, "Focus on Table Viewer");
