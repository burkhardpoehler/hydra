...
public class CustomizeData implements Comparable<CustomizeData> {
   ...
   public int compareTo(CustomizeData custData) {
	...
	/**
	 * @return the defaultCust
	 */
	public boolean isDefaultCust() {
		return defaultCust;
	}
	
	/**
	 * @param defaultCust the defaultCust to set
	 */
	public void setDefaultCust(boolean defaultCust) {
